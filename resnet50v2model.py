...
word_to_index = {}
with open ("C:/Users/Satya Kalyan/Downloads/word_to_idx.pkl", 'rb') as file:
    word_to_index = pd.read_pickle(file, compression=None)

index_to_word = {}
with open ("C:/Users/Satya Kalyan/Downloads/idx_to_word.pkl", 'rb') as file:
    index_to_word = pd.read_pickle(file, compression=None)



print("Loading the model...")
model = load_model('C:/Users/Satya Kalyan/OneDrive/Desktop/resnet50v2data/model25.h5')

resnet50_model = ResNet50V2 (weights = 'imagenet', input_shape = (224, 224, 3))
